        ...
        <!--<van-row>-->
          ...
          <!--<van-col span="24" style="margin-top: 1em">-->
            <!--<el-date-picker-->
              ...
              <!--type="date"-->
              <!--size="mini"-->
              <!--placeholder="选择日期" style="width: 11em;"-->
              <!--value-format="yyyy-MM-dd"-->
              <!--onfocus="this.blur();">-->
            <!--</el-date-picker>-->
          ...
          <!--</van-col>-->
        <!--</van-row>-->
        <!--&lt;!&ndash;<van-row style="margin-top: 1em;">&ndash;&gt;-->
          <!--&lt;!&ndash;&lt;!&ndash;<el-date-picker&ndash;&gt;&ndash;&gt;-->
          <!--&lt;!&ndash;&lt;!&ndash;v-model="value1"&ndash;&gt;&ndash;&gt;-->
          <!--&lt;!&ndash;&lt;!&ndash;type="date"&ndash;&gt;&ndash;&gt;-->
          <!--&lt;!&ndash;&lt;!&ndash;size="mini"&ndash;&gt;&ndash;&gt;-->
          <!--&lt;!&ndash;&lt;!&ndash;placeholder="选择日期" style="width: 9em;"&ndash;&gt;&ndash;&gt;-->
          <!--&lt;!&ndash;&lt;!&ndash;value-format="yyyy-MM-dd"&ndash;&gt;&ndash;&gt;-->
          <!--&lt;!&ndash;&lt;!&ndash;class="dataone">&ndash;&gt;&ndash;&gt;-->
          <!--&lt;!&ndash;&lt;!&ndash;</el-date-picker>&ndash;&gt;&ndash;&gt;-->
          <!--&lt;!&ndash;<van-col span="11">&ndash;&gt;-->
            <!--&lt;!&ndash;<div style="border: 1px solid #dcdfe6;border-radius: 4px;padding: 0.2em 0.4em">&ndash;&gt;-->
              <!--&lt;!&ndash;<input type="date" v-model="value1" style="border: none;background-color: white;width: 100%;color: #dcdfe6">&ndash;&gt;-->
            <!--&lt;!&ndash;</div>&ndash;&gt;-->
          <!--&lt;!&ndash;</van-col>&ndash;&gt;-->

          <!--&lt;!&ndash;<van-col span="2">&ndash;&gt;-->
            <!--&lt;!&ndash;<span style="margin:0;">至</span>&ndash;&gt;-->
          <!--&lt;!&ndash;</van-col>&ndash;&gt;-->
          <!--&lt;!&ndash;<van-col span="11">&ndash;&gt;-->
            <!--&lt;!&ndash;<div style="border: 1px solid #dcdfe6;border-radius: 4px;padding: 0.2em 0.4em">&ndash;&gt;-->
              <!--&lt;!&ndash;<input type="date" v-model="value2" style="border: none;background-color: white;width: 100%;color: #dcdfe6">&ndash;&gt;-->
          ...
          <!--&lt;!&ndash;</van-col>&ndash;&gt;-->
          <!--&lt;!&ndash;&lt;!&ndash;<el-date-picker&ndash;&gt;&ndash;&gt;-->
          <!--&lt;!&ndash;&lt;!&ndash;v-model="value2"&ndash;&gt;&ndash;&gt;-->
          <!--&lt;!&ndash;&lt;!&ndash;type="date"&ndash;&gt;&ndash;&gt;-->
          <!--&lt;!&ndash;&lt;!&ndash;size="mini"&ndash;&gt;&ndash;&gt;-->
          <!--&lt;!&ndash;&lt;!&ndash;placeholder="选择日期" style="width: 9em;"&ndash;&gt;&ndash;&gt;-->
          <!--&lt;!&ndash;&lt;!&ndash;value-format="yyyy-MM-dd"&ndash;&gt;&ndash;&gt;-->
          <!--&lt;!&ndash;&lt;!&ndash;readonly>&ndash;&gt;&ndash;&gt;-->
          <!--&lt;!&ndash;&lt;!&ndash;</el-date-picker>&ndash;&gt;&ndash;&gt;-->
        <!--&lt;!&ndash;</van-row>&ndash;&gt;-->
      <!--</div>-->
    </el-card>
