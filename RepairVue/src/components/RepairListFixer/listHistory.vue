<template>
  ...
  <div id="waitListFixer" style=" height:100vh;background-color: #eaeaea;">
    ...
    <div class="listCon container-fluid" style="width: 93%;background-color: white;display: inline-block;text-align: center;border-radius: 5px;margin-top: 10px;font-size: 16px;padding: 20px 15px;color: #989898;" v-for="list in listData" v-if="list.state == 0">
      <van-row type="flex">
        <van-col span="9">维修状态：已完成</van-col>
      </van-row>
      <!--<div class="row">-->
