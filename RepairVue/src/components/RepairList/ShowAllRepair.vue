<template>
  <div id="NoRepair">
    <div class="listCon container-fluid" style="width: 93%;background-color: white;display: inline-block;text-align: center;border-radius: 5px;margin-top: 10px;font-size: 16px;padding: 20px 15px;color: #989898;"  v-for="(rep,index) in RepairList" @click="showBackAll(index)">
      <van-row>
        <van-col span="6">维修状态：</van-col>
        <van-col span="15" offset="2"><span v-html="status[rep.state].text"></span></van-col>
      </van-row>
