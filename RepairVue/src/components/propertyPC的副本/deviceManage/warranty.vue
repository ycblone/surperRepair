        ...
        <el-main>
          <div>
            <el-tabs type="border-card" class="el-tabs">
              ...
              <el-table
                :data="data1.filter(data1 => !search || data1.name.toLowerCase().includes(search.toLowerCase()))"
                style="width: 100%">
                <el-table-column
                  label="设备名称"
                  width="100"
                ...
                <el-table-column
                  ...
                  <template slot-scope="scope">
                    <router-link :to="{ name: 'warrantyPCMes', params: { elementId: scope.row.id }}">
              ...
              <el-tab-pane label="维修工单管理" class="el-tab-pane">
                <el-table
                  :data="data2.filter(data2 => !search || data2.name.toLowerCase().includes(search.toLowerCase()))"
                  style="width: 100%">
                  <el-table-column
                    label="设备名称"
                    width="100"
                  ...
                  <el-table-column
                    ...
                    <template slot-scope="scope">
                        <router-link :to="{ name: 'repair1PC', params: { repairId: scope.row.id }}">维修工单详情</router-link>;
                    </template>
                  </el-table-column>
                </el-table>
              </el-tab-pane>
