    ...
    <el-card class="box-card">
      ...
      <div class="block" style="width: 100%;padding: 0;">
        <van-row>
          ...
          <!--<van-col span="24" style="margin-top: 1em">-->
            <!--<el-date-picker-->
              ...
              <!--type="date"-->
              <!--size="mini"-->
              <!--placeholder="选择日期" style="width: 9em;"-->
        ...
        <van-row style="margin-top: 1em;">
          ...
          <!--</el-date-picker>-->
          <van-col span="11">
            <div style="border: 1px solid #dcdfe6;border-radius: 4px;padding: 0.2em 0.4em">
              <input type="date" v-model="value1" style="border: none;background-color: white;width: 100%;color: #dcdfe6">
            </div>
          </van-col>
          ...
          <van-col span="11">
            <div style="border: 1px solid #dcdfe6;border-radius: 4px;padding: 0.2em 0.4em">
              <input type="date" v-model="value2" style="border: none;background-color: white;width: 100%;color: #dcdfe6">
            </div>
          </van-col>
          <!--<el-date-picker-->
          <!--v-model="value2"-->
